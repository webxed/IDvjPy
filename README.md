...
**IDvjPy_term** v1.46 — умный терминал для создания командных строк из тегов.
...
- LLM из TUI: `:llm <провайдер> <сообщение>` (конфиг `llm_providers.yml`, ключи — из окружения; Tab дополняет имена провайдеров)
