...
**IDvjPy_term** v1.47 — умный терминал для создания командных строк из тегов.
...
- LLM из TUI: `:llm [провайдер] сообщение` (без имени — провайдер `default:`; конфиг `llm_providers.yml`, ключи — из окружения; Tab дополняет имена)
