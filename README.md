...
**IDvjPy_term** v1.156 — умный терминал для создания командных строк из тегов.
...
| `:` | Команды приложения | `:q`, `:cd`, `:fm`, `:term`, `:session`, `:new`, `:send`, `:welcome`, `:backup`, `:screensaver`, `:r`, `:cmd`, `:kctx`, `:run`, `:playbook`, `:md`, `:rg`, `:lang`, `:relang`, `:?` |
