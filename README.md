...
**IDvjPy_term** v1.154 — умный терминал для создания командных строк из тегов.
...
| Правый клик | Вставка из буфера в строку ввода — в том числе когда фокус в журнале или в списке подсказок (курсор в строке не нужен). Ссылки (`--seed`, `.md`, `:команды`) от правого клика не выполняются |
