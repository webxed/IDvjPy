...
language: en                 # язык интерфейса: :lang / --lang / $IDVJPY_LANG; `auto` — по $LANG; тексты в src/locales (части <lang>/*.yml, справка в help/<lang>/)
