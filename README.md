...
**IDvjPy_term** v1.48 — умный терминал для создания командных строк из тегов.
...
- LLM из TUI: `:llm [провайдер] сообщение` (без имени — провайдер `default:`; `$OUT`/`$BLOCK` вставляют вывод блока; ключи — из окружения)
