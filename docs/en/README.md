...
term_open: window            # where a terminal opens (`:term`, `:new`, `& cmd`): window — a new window, tab — a tab in an open one (gnome-terminal --tab, konsole --new-tab, …); $IDVJPY_TERM_OPEN=tab
