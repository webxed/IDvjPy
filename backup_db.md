...
Скрипт для импорта и экспорта базы тегов IDvjPy_term (**v1.140**, `mytags.db`). Поддерживает форматы JSON и CSV для редактирования команд в табличных редакторах.
