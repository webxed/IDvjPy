...
TUI на Textual для запуска shell-команд с тегированной историей в SQLite. Версия: **v1.92**.
...
| File | Coverage |
|------|----------|
| `test_cmd.md` | Manual plan v1.39 (app v1.92) |
...
| `src/app.py` | TUI (`CommandRunner`), v1.92 |
