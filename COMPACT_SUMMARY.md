...
TUI на Textual для запуска shell-команд с тегированной историей в SQLite. Версия: **v1.50**.
...
| File | Coverage |
|------|----------|
| `test_cmd.md` | Manual plan v1.6 (app v1.50) |
...
| `src/app.py` | TUI (`CommandRunner`), v1.50 |
