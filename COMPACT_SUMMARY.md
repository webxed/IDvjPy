...
TUI на Textual для запуска shell-команд с тегированной историей в SQLite. Версия: **v1.101**.
...
| File | Coverage |
|------|----------|
| `test_cmd.md` | Manual plan v1.48 (app v1.101) |
...
| `src/app.py` | TUI (`CommandRunner`), v1.101 |
