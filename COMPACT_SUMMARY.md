...
TUI на Textual для запуска shell-команд с тегированной историей в SQLite. Версия: **v1.113**.
...
| File | Coverage |
|------|----------|
| `test_cmd.md` | Manual plan v1.53 (app v1.113) |
...
| `src/app.py` | TUI (`CommandRunner`), v1.113 |
