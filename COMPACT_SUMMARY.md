...
TUI на Textual для запуска shell-команд с тегированной историей в SQLite. Версия: **v1.62**.
...
| File | Coverage |
|------|----------|
| `test_cmd.md` | Manual plan v1.13 (app v1.62) |
...
| `src/app.py` | TUI (`CommandRunner`), v1.62 |
