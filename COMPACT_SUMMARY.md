...
TUI на Textual для запуска shell-команд с тегированной историей в SQLite. Версия: **v1.116**.
...
| File | Coverage |
|------|----------|
| `test_cmd.md` | Manual plan v1.60 (app v1.116) |
...
| `src/app.py` | TUI (`CommandRunner`), v1.116 |
