...
TUI на Textual для запуска shell-команд с тегированной историей в SQLite. Версия: **v1.100**.
...
| File | Coverage |
|------|----------|
| `test_cmd.md` | Manual plan v1.47 (app v1.100) |
...
| `src/app.py` | TUI (`CommandRunner`), v1.100 |
