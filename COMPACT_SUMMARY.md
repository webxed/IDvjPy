...
TUI на Textual для запуска shell-команд с тегированной историей в SQLite. Версия: **v1.99**.
...
| File | Coverage |
|------|----------|
| `test_cmd.md` | Manual plan v1.46 (app v1.99) |
...
| `src/app.py` | TUI (`CommandRunner`), v1.99 |
