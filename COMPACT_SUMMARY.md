...
TUI на Textual для запуска shell-команд с тегированной историей в SQLite. Версия: **v1.82**.
...
| File | Coverage |
|------|----------|
| `test_cmd.md` | Manual plan v1.29 (app v1.82) |
...
| `src/app.py` | TUI (`CommandRunner`), v1.82 |
