...
TUI на Textual для запуска shell-команд с тегированной историей в SQLite. Версия: **v1.89**.
...
| File | Coverage |
|------|----------|
| `test_cmd.md` | Manual plan v1.36 (app v1.89) |
...
| `src/app.py` | TUI (`CommandRunner`), v1.89 |
