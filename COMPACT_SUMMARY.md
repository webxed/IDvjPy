...
TUI на Textual для запуска shell-команд с тегированной историей в SQLite. Версия: **v1.98**.
...
| File | Coverage |
|------|----------|
| `test_cmd.md` | Manual plan v1.45 (app v1.98) |
...
| `src/app.py` | TUI (`CommandRunner`), v1.98 |
