...
TUI на Textual для запуска shell-команд с тегированной историей в SQLite. Версия: **v1.109**.
...
| File | Coverage |
|------|----------|
| `test_cmd.md` | Manual plan v1.54 (app v1.109) |
...
| `src/app.py` | TUI (`CommandRunner`), v1.109 |
