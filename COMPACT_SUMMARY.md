...
TUI на Textual для запуска shell-команд с тегированной историей в SQLite. Версия: **v1.110**.
...
| File | Coverage |
|------|----------|
| `test_cmd.md` | Manual plan v1.55 (app v1.110) |
...
| `src/app.py` | TUI (`CommandRunner`), v1.110 |
